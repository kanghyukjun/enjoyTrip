...
<template>
  <div
    class="w-full h-1/6 flex flex-row items-center justify-center rounded-md bg-zinc-100 border-zinc-300 border-2 hover:border-4 transition-all"
  >
    ...
    <div class="w-5/12 h-full flex flex-col items-center justify-center">
      <div class="w-5/6 h-5/6 flex flex-col items-center justify-center">
        <img
