<script setup>
import UserPageSideNavBarListItem from "@/components/userpage/navbar/UserPageSideNavBarListItem.vue";
</script>

<template>
  <ul class="ml-4 h-full">
    <div class="flex flex-col justify-center items-start gap-2 font-kor">
      <li class="mt-4">
